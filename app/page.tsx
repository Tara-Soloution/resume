      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 print:max-w-none print:px-0 print:py-0 print:aspect-[1/1.4142] print:w-[210mm] print:h-[297mm]">
        ...
        <div className="relative mb-5 pb-5 border-b border-gray-100">
          ...
          <div className="flex items-start justify-between relative z-10">
            <div className="flex-1 space-y-2 pt-2">
              ...
              <h2 className="text-lg font-medium text-gray-700 pl-1">Senior Frontend Developer | Full Stack Engineer</h2>
        ...
        <div className="mt-2 mb-8 bg-gray-50 p-4 rounded-lg border border-gray-100">
          ...
          <p className="text-xs text-gray-600">
            <span className="font-medium">Experienced Full-Stack Developer</span> with solid expertise in <span className="font-semibold">Frontend and Backend Development</span>. Specialized in <span className="font-semibold">React.js</span>, <span className="font-semibold">Next.js</span>, <span className="font-semibold">PHP/Laravel</span> and <span className="font-semibold">Node.js</span>. Proven success in developing scalable web applications and implementing user-friendly interfaces. Experience in technical leadership and project coordination with focus on Clean Code and Best Practices.
          </p>
        </div>
        ...
        <div className="mt-6 grid grid-cols-3 gap-4">
            ...
            <section>
              ...
              <div className="mb-2 relative group hover:bg-gray-50/80 rounded-md transition-colors duration-300 border border-gray-100">
                ...
                <div className="pl-3 py-2">
                  <h3 className="text-sm font-bold text-gray-800 group-hover:text-gray-900 transition-colors">Frontend Web Developer</h3>
                  ...
                  <ul className="space-y-0.5 text-gray-700 text-xs pl-0.5">
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      ...
                      <span className="leading-normal"><span className="font-bold">Development and maintenance</span> of <span className="font-semibold">responsive web applications</span> with React.js and Next.js</span>
                    </li>
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      <span className="text-gray-400 mr-1.5 mt-0.5 text-[10px]">●</span>
                      <span className="leading-normal"><span className="font-bold">Collaboration</span> with <span className="font-semibold">UI/UX designers & backend teams</span> to optimize user experience</span>
                    </li>
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      <span className="text-gray-400 mr-1.5 mt-0.5 text-[10px]">●</span>
                      <span className="leading-normal"><span className="font-bold">Implementation</span> of <span className="font-semibold">State Management & Performance Optimization</span> with Redux and Context API</span>
                    </li>
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      <span className="text-gray-400 mr-1.5 mt-0.5 text-[10px]">●</span>
                      <span className="leading-normal"><span className="font-bold">Development</span> of <span className="font-semibold">reusable UI components</span> and Custom Hooks for improved code reusability</span>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="pl-3 py-2">
                  ...
                  <ul className="space-y-0.5 text-gray-700 text-xs pl-0.5">
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      ...
                      <span className="leading-normal"><span className="font-bold">Development</span> of <span className="font-semibold">responsive user interfaces</span> with modern React patterns</span>
                    </li>
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      <span className="text-blue-300 mr-1.5 mt-0.5 text-[10px]">●</span>
                      <span className="leading-normal"><span className="font-bold">Implementation</span> of <span className="font-semibold">OAuth2 and JWT-based authentication</span></span>
                    </li>
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      <span className="text-blue-300 mr-1.5 mt-0.5 text-[10px]">●</span>
                      <span className="leading-normal"><span className="font-bold">Conducting</span> <span className="font-semibold">unit and integration tests</span> with Jest and React Testing Library</span>
                    </li>
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      <span className="text-blue-300 mr-1.5 mt-0.5 text-[10px]">●</span>
                      <span className="leading-normal"><span className="font-bold">Optimization</span> of <span className="font-semibold">application performance</span> through code splitting and lazy loading</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="mb-2 relative group hover:bg-blue-50/30 rounded-md transition-colors duration-300 border border-blue-50/50">
                ...
                <div className="pl-3 py-2">
                  ...
                  <ul className="space-y-0.5 text-gray-700 text-xs pl-0.5">
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      <span className="text-blue-300 mr-1.5 mt-0.5 text-[10px]">●</span>
                      <span className="leading-normal"><span className="font-bold">Development</span> of <span className="font-semibold">reusable frontend components</span></span>
                    </li>
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      <span className="text-blue-300 mr-1.5 mt-0.5 text-[10px]">●</span>
                      <span className="leading-normal"><span className="font-bold">Implementation</span> of <span className="font-semibold">RESTful APIs and real-time functionality</span></span>
                    </li>
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      <span className="text-blue-300 mr-1.5 mt-0.5 text-[10px]">●</span>
                      <span className="leading-normal"><span className="font-bold">Conducting</span> <span className="font-semibold">tests and quality control</span></span>
                    </li>
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      <span className="text-blue-300 mr-1.5 mt-0.5 text-[10px]">●</span>
                      <span className="leading-normal"><span className="font-bold">Integration</span> of <span className="font-semibold">database systems and optimization</span> of <span className="font-semibold">database queries</span></span>
                    </li>
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      <span className="text-blue-300 mr-1.5 mt-0.5 text-[10px]">●</span>
                      <span className="leading-normal"><span className="font-bold">Development</span> and <span className="font-bold">maintenance</span> of <span className="font-semibold">microservices architectures</span> with <span className="font-semibold">Docker and Kubernetes</span></span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="print:break-before-page mb-2 relative group hover:bg-blue-50/30 rounded-md transition-colors duration-300 border border-blue-50/50">
                <div className="absolute left-0 top-0 w-0.5 h-full bg-gradient-to-b from-blue-500 to-cyan-500 rounded-l opacity-75 group-hover:opacity-100 transition-opacity"></div>
                <div className="pl-3 py-2">
                  <h3 className="text-sm font-bold text-gray-800 group-hover:text-blue-600 transition-colors">Technical Manager</h3>
                  ...
                  <div className="bg-blue-50/30 p-2 rounded-md mb-2">
                    <p className="text-xs text-gray-600 leading-relaxed">
                      As Technical Manager, I was responsible for strategic planning and leading development projects,
                      with focus on agile methods and efficient team coordination.
                    </p>
                  </div>
                  <ul className="space-y-0.5 text-gray-700 text-xs pl-0.5">
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      ...
                      <span className="leading-normal">
                        <span className="font-bold">Leading</span> <span className="font-semibold">project planning sessions</span> and
                        <span className="font-semibold"> implementing agile development methods</span>
                      </span>
                    </li>
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      <span className="text-blue-300 mr-1.5 mt-0.5 text-[10px]">●</span>
                      <span className="leading-normal">
                        <span className="font-bold">Optimization</span> of <span className="font-semibold">development processes</span> through
                    ...
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      <span className="text-blue-300 mr-1.5 mt-0.5 text-[10px]">●</span>
                      <span className="leading-normal">
                        <span className="font-bold">Successful delivery</span> of <span className="font-semibold">5+ major projects</span> through
                        <span className="font-semibold"> effective risk management</span>
                      </span>
                    </li>
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      <span className="text-blue-300 mr-1.5 mt-0.5 text-[10px]">●</span>
                      <span className="leading-normal">
                        <span className="font-bold">Improvement</span> of <span className="font-semibold">team productivity by 30%</span> through
              ...
              <div className="mb-2 relative group hover:bg-blue-50/30 rounded-md transition-colors duration-300 border border-blue-50/50">
                <div className="absolute left-0 top-0 w-0.5 h-full bg-gradient-to-b from-blue-500 to-cyan-500 rounded-l opacity-75 group-hover:opacity-100 transition-opacity"></div>
                <div className="pl-3 py-2">
                  <h3 className="text-sm font-bold text-gray-800 group-hover:text-blue-600 transition-colors">Web Developer</h3>
                  ...
                  <ul className="space-y-0.5 text-gray-700 text-xs pl-0.5">
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      <span className="text-blue-300 mr-1.5 mt-0.5 text-[10px]">●</span>
                      <span className="leading-normal"><span className="font-bold">Development</span> of <span className="font-semibold">desktop applications and websites</span></span>
                    </li>
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      <span className="text-blue-300 mr-1.5 mt-0.5 text-[10px]">●</span>
                      <span className="leading-normal"><span className="font-bold">Analysis and design</span> of <span className="font-semibold">databases</span></span>
                    </li>
                    <li className="flex items-start group/item hover:bg-white/80 p-1 rounded transition-all duration-200">
                      <span className="text-blue-300 mr-1.5 mt-0.5 text-[10px]">●</span>
                      <span className="leading-normal"><span className="font-bold">Conducting</span> <span className="font-semibold">software reviews and controls</span></span>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="pl-3 py-1.5">
                  ...
                  <ul className="space-y-0.5 text-gray-700 text-xs">
                    <li className="flex items-start group/item hover:bg-white/80 p-0.5 rounded-lg transition-all duration-200">
                      ...
                      <span className="leading-tight"><span className="font-bold">High-quality master's program</span> focusing on cutting-edge technologies and methods</span>
                    </li>
                    <li className="flex items-start group/item hover:bg-white/80 p-0.5 rounded-lg transition-all duration-200">
                      <span className="text-blue-500 mr-1.5 font-bold group-hover/item:text-blue-600">▹</span>
                ...
                <div className="group bg-gray-50 p-2 rounded-lg hover:bg-gray-100 transition-all duration-300 border border-gray-100">
                  <div className="text-xs text-gray-700 flex items-start">
                    ...
                    <div className="flex-1">
                      <span className="font-bold group-hover:text-blue-600 transition-colors">Skin Disease Detection System</span>
                      <p className="text-xs text-gray-600 leading-tight mt-0.5">
                        An <span className="font-bold">AI-powered deep learning system</span> for precise detection of 5 specific skin diseases. The system uses <span className="font-semibold">CNN</span> for image analysis.
                      </p>
                ...
                <div className="group bg-gray-50 p-2 rounded-lg hover:bg-gray-100 transition-all duration-300 border border-gray-100">
                  <div className="text-xs text-gray-700 flex items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-600 leading-tight mt-0.5">
                        A comprehensive <span className="font-bold">enterprise management platform</span> with integrated modules for <span className="font-semibold">user, file, product, and task management</span>.
                      </p>
                      <div className="flex flex-wrap gap-1 mt-1">
          ...
          <div className="col-span-1">
            ...
            <section>
              ...
              <div className="space-y-2">
                <div>
                  <h3 className="text-xs font-bold text-gray-700 mb-1">Frontend Development:</h3>
                ...
                <div className="mt-2">
                  <h3 className="text-xs font-bold text-gray-700 mb-1">Backend Development:</h3>
                  <div className="flex flex-wrap gap-1">
                ...
                <div className="mt-2">
                  <h3 className="text-xs font-bold text-gray-700 mb-1">Databases:</h3>
                  <div className="flex flex-wrap gap-1">
                ...
                <div className="mt-2">
                  <h3 className="text-xs font-bold text-gray-700 mb-1">Tools & Methods:</h3>
                  <div className="flex flex-wrap gap-1">
            ...
            {/* Awards Section */}
            <section className="mt-4">
              <h2 className="text-base font-bold border-b pb-1 mb-2 text-gray-800">AWARDS</h2>
              <div>
